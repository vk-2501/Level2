...
// So we can rewrite the above condition that if any factor of k is present
//  in a and any other factor of k is present in b then their multiplication 
// will be divisble by k
